						...
						$.ajax({
							...
							success : function(result){
								if(result.success){
									...
									layer.msg("分配的角色数据成功", {time:1000, icon:6}, function(){
									});
								}else{
									layer.msg("分配的角色数据失败", {time:1000, icon:5, shift:6}, function(){
									});
								}
							}
						})
						...
						$.ajax({
							...
							success : function(result){
								if(result.success){
									...
									layer.msg("取消的角色数据成功", {time:1000, icon:6}, function(){
									});
								}else{
									layer.msg("取消的角色数据失败", {time:1000, icon:5, shift:6}, function(){
									});
								}
							}
						})
