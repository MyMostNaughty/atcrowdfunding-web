			  ...
			  <div class="panel-body">
				<form role="form">
				  <div class="form-group">
					...
					<input type="text" class="form-control" id="permissionname" value="${permission.name}" placeholder="许可名称">
				  </div>
				  <div class="form-group">
				  ...
				  <button id="updateBtn" type="button" class="btn btn-success"><i class="glyphicon glyphicon-pencil"></i> 新增</button>
